...
"""
    return the list of dict {'artist': artist, 'works': [{'title' : work, 'price' : price}]} format
"""
def questiom_3(all_soup):
...
def dump_json(obj_list):
    ...
    with open('problem3_1.json', 'w') as outfile:
...
# caller
dump_json(questiom_3(read_soup(file_names)))
